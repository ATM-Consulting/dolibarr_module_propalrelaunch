...
print '<input type="hidden" name="action" value="set_PROPALAUTOSEND_MAXIMAL_AMOUNT">';
print '<input type="text" name="PROPALAUTOSEND_MAXIMAL_AMOUNT" value="'.$conf->global->PROPALAUTOSEND_MAXIMAL_AMOUNT.'" size="54" />&nbsp;';
