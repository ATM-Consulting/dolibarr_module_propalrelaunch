...
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="set_PROPALAUTOSEND_SECOND_NB_DAY">';
print '+&nbsp;<input type="text" name="PROPALAUTOSEND_SECOND_NB_DAY" value="'.$conf->global->PROPALAUTOSEND_SECOND_NB_DAY.'" size="5" />&nbsp;'.$langs->trans('Days').'&nbsp;';
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="set_PROPALAUTOSEND_THIRD_NB_DAY">';
print '+&nbsp;<input type="text" name="PROPALAUTOSEND_THIRD_NB_DAY" value="'.$conf->global->PROPALAUTOSEND_THIRD_NB_DAY.'" size="5" />&nbsp;'.$langs->trans('Days').'&nbsp;';
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
