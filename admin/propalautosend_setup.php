...
print '<input type="text" name="PROPALAUTOSEND_MINIMAL_AMOUNT" value="'.(!empty($conf->global->PROPALAUTOSEND_MINIMAL_AMOUNT) ? $conf->global->PROPALAUTOSEND_MINIMAL_AMOUNT : '').'" size="54" />&nbsp;';
...
if (!empty($conf->fckeditor) && $conf->fckeditor->enabled && !empty($conf->global->FCKEDITOR_ENABLE_MAIL)) $withfckeditor = 1;
...
$doleditor=new DolEditor('PROPALAUTOSEND_MSG_THIRDPARTY', !empty($conf->global->PROPALAUTOSEND_MSG_THIRDPARTY) ? $conf->global->PROPALAUTOSEND_MSG_THIRDPARTY : '', '', 153, 'dolibarr_notes', 'In', true, true, $withfckeditor, 10, 52);
$doleditor->Create();
print '&nbsp;<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
$doleditor=new DolEditor('PROPALAUTOSEND_MSG_CONTACT', !empty($conf->global->PROPALAUTOSEND_MSG_CONTACT) ? $conf->global->PROPALAUTOSEND_MSG_CONTACT : '', '', 153, 'dolibarr_notes', 'In', true, true, $withfckeditor, 10, 52);
$doleditor->Create();
print '&nbsp;<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print '+&nbsp;<input type="text" name="PROPALAUTOSEND_DEFAULT_NB_DAY" value="'.(!empty($conf->global->PROPALAUTOSEND_DEFAULT_NB_DAY) ? $conf->global->PROPALAUTOSEND_DEFAULT_NB_DAY : '').'" size="5" />&nbsp;'.$langs->trans('Days').'&nbsp;';
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
